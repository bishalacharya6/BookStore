...
{
    /// <inheritdoc />
    public partial class orderDetailsAndHeadersAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicatoinUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ShippingDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    OrderTotal = table.Column<double>(type: "float", nullable: false),
                    OrderStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PaymenetStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    StreedAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
